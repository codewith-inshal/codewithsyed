...
function ServicesHero() {
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center text-center px-6 ">
      {/* Glow Background */}
      <div className="absolute -top-30 -left-30 -w-75 -h-75 bg-lime-400/20 blur-[150px] rounded-full"></div>
      <div className="absolute -bottom-30 -right-30 -w-75 -h-75 bg-lime-500/20 blur-[150px] rounded-full"></div>
      ...
      >
        <h1 className="text-5xl md:text-6xl font-extrabold pb-10">
